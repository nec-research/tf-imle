...
def to_logfile(c, path):
    outfile = "{}/temperature_beaker_v10.{}.log".format(path, summary(c).replace("/", "_"))
    return outfile
...
def main(argv):
    ...
    path = 'logs/warcraft/temperature_beaker_v10'
    is_rc = False
    ...
    for cfg in configurations:
        ...
        if is_rc is True and os.path.isfile(logfile):
            ...
            with open(logfile, 'r', encoding='utf-8', errors='ignore') as f:
                ...
                if 'busy or unavailable' in content:
                    running = False
