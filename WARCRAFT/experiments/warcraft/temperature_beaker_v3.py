...
def to_logfile(c, path):
    outfile = "{}/temperature_beaker_v3.{}.log".format(path, summary(c).replace("/", "_"))
    return outfile
...
def main(argv):
    hyp_space = dict(
        ...
        temperature=[0.001, 0.01, 0.1, 1.0, 10.0, 100.0, 1000.0],
        use_gamma=[True],
    ...
    path = 'logs/warcraft/temperature_beaker_v3'
    is_rc = False
