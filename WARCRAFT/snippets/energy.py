...
clf = intopt_energy(input_size=X_1gtrain.shape[1], param=param, hidden_size=1, optimizer=optim.Adam, lr=0.7,
                    num_layers=1, epochs=4, damping=1e-6, thr=0.1, validation_relax=False)
